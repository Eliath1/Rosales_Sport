...
import { getCommissionReport } from "@/lib/services/paymentService";
    ...
    <div className="min-h-screen bg-zinc-50">
      <header className="bg-black text-white">
        <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
          ...
          <Link href="/admin/orders" className="text-xs font-bold uppercase tracking-wide text-white/70 hover:text-white">Pedidos</Link>
        </div>
      </header>
