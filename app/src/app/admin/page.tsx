...
import { getPipelineStats, listQuotes } from "@/lib/services/quoteService";
import { getOrderPipelineStats, listOrders } from "@/lib/services/orderService";
      ...
      <header className="bg-black text-white">
        <div className="mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex flex-wrap gap-3 text-xs font-bold uppercase tracking-wide">
            <Link href="/admin/orders" className="text-white/70 hover:text-white">Pedidos</Link>
            <Link href="/admin/payments" className="text-white/70 hover:text-white">Comisiones</Link>
            <Link href="/admin/quotes" className="text-white/70 hover:text-white">Cotizaciones</Link>
            <Link href="/admin/products" className="text-white/70 hover:text-white">Catalogo</Link>
            <Link href="/admin/customers" className="text-white/70 hover:text-white">Clientes</Link>
            <Link href="/admin/testimonials" className="text-white/70 hover:text-white">Testimonios</Link>
            <form
              action={async () => {
                "use server";
