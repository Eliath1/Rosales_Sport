...
1. **Locate current stage** - Compare deployed artifacts (`netlify.toml` publish dir, `app/` vs `demo/`, `app/prisma/schema.prisma`) against the declared stage in `docs/architecture/03-staged-delivery-roadmap.md`.
